...
<?php foreach($attributes->onlyProps(['name', 'label' => null, 'value' => null, 'hasFeedback' => true]) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
<?php $attributes = $attributes->exceptProps(['name', 'label' => null, 'value' => null, 'hasFeedback' => true]); ?>
<?php foreach (array_filter((['name', 'label' => null, 'value' => null, 'hasFeedback' => true]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
...
<input type="date" name="<?php echo e($name); ?>" value="<?php echo e(old($name, $value)); ?>"
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH /Users/ouraniantrizi/Desktop/Customer-Relationship-Management-System-main/resources/views/components/forms/date.blade.php ENDPATH**/ ?>