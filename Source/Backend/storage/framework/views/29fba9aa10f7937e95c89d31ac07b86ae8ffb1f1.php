...
<?php foreach($attributes->onlyProps(['name', 'label' => null, 'options', 'selected' => null, 'hasFeedback' => true]) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
<?php $attributes = $attributes->exceptProps(['name', 'label' => null, 'options', 'selected' => null, 'hasFeedback' => true]); ?>
<?php foreach (array_filter((['name', 'label' => null, 'options', 'selected' => null, 'hasFeedback' => true]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
...
<select name=<?php echo e($name); ?>
  ...
  <?php $__currentLoopData = $options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <option value="<?php echo e($value); ?>" <?php if($value === $selected): ?> selected <?php endif; ?>><?php echo e($key); ?>
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH /Users/ouraniantrizi/Desktop/Customer-Relationship-Management-System-main/resources/views/components/forms/select.blade.php ENDPATH**/ ?>