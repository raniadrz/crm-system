...
<?php foreach($attributes->onlyProps(['name', 'label' => null, 'value' => null]) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
<?php $attributes = $attributes->exceptProps(['name', 'label' => null, 'value' => null]); ?>
<?php foreach (array_filter((['name', 'label' => null, 'value' => null]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
...
<input type="email" name="<?php echo e($name); ?>" value="<?php echo e(old($name, $value)); ?>"
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH /Users/ouraniantrizi/Desktop/Customer-Relationship-Management-System-main/resources/views/components/forms/email.blade.php ENDPATH**/ ?>